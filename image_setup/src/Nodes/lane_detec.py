...
import math
import sys
from image_setup.msg import State
...
class LaneDetector:
  ...
  def __init__(self):
    ...
    self.image_pub = rospy.Publisher("ycam_msg", State, queue_size=1)

    self.bridge = CvBridge()
    self.image_sub = rospy.Subscriber("original_img",Image,self.callback)
